...
export default function Connect() {
  return (
    <section
      ...
      style={{
        background: 'linear-gradient(135deg, #8a6f52 0%, #6f5840 100%)',
      }}
    >
      <div className="max-w-2xl mx-auto text-white">
        <div className="flex justify-center mb-6 text-[#f6e2df]">
          <LotusMark className="w-12 h-12" />
        </div>
        <h2 className="font-serif text-3xl md:text-4xl mb-4">
          Follow along @fitfrequency.wellness
        </h2>
        <p className="text-[#f3e6d8] mb-10">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 px-8 py-3 rounded-full bg-white text-[#6f5840] tracking-wide hover:bg-[#f6e2df] transition-colors"
        >
